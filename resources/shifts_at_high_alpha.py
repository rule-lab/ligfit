...
l_total = numpy.logspace(-2, 3.5, 200)
...
fig = plt.figure()
ax = fig.gca()
plt.title('Contrasting 2 and 10-fold variations at high alpha')
plt.plot(l_total, model_func(1.0, 1e+7, 1.0, l_total), label='alpha = 1e7')
plt.plot(l_total, model_func(1.0, 1e+8, 1.0, l_total), label='alpha = 1e8')
plt.plot(l_total, model_func(1.0, 1e+6, 1.0, l_total), label='alpha = 1e6')
plt.plot(l_total, model_func(1.0, 5e+6, 1.0, l_total), label='alpha = 5e6')
plt.plot(l_total, model_func(1.0, 2e+7, 1.0, l_total), label='alpha = 2e7')
ax.set_xscale('log')
ax.set_xlabel('Log-Total Ligand [L] (conc.)')
ax.set_ylabel('Dimerized Protein [PLP](conc.)')
...
#plt.title('Solving for protein dimerization in varying ligand and alpha')
