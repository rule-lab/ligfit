...
!    below (line 74)by the user in this module.  mpwds is the equivalent in
!    words.  It is calculated below from mpipl according to the formula:
...
!   mpipl     1000     (Set in line 74 above) Default precision in digits.
!   mpwds    mpipl/mpdpw+2  Default precision in mantissa words.
...
private &
  mp_absr, mp_absz, mp_acos, mp_aimag, mp_aint, mp_anint, mp_asin, &
  mp_atan, mp_atan2, mp_ator, mp_berne, mp_besselj, mp_cexp, mp_clog, &
  mp_conjg, mp_cos, mp_cosh, mp_csqrt, mp_cssh, mp_cssn, mp_dctoz, &
  mp_dctoz2, mp_dtor, mp_dtor2, mp_eform, mp_exp, mp_fform, mp_gamma, &
  mp_incgamma, mp_init, mp_log, mp_log2, mp_max, mp_min, mp_nrt, mp_pi, &
  mp_prodd, mp_rtod, mp_rtor, mp_rtoz, mp_quotd, mp_readr1, mp_readr2, &
  mp_readr3, mp_readr4, mp_readr5, mp_readz1, mp_readz2, mp_readz3, &
  mp_readz4, mp_readz5, mp_sign, mp_sin, mp_sinh, mp_sqrt, mp_strcon, &
  mp_tan, mp_tanh, mp_wprec, mp_wprecz, mp_writer, mp_writez, mp_ztodc, &
  mp_ztor, mp_ztoz
...
!   In version #2, the argument iprec is required.
    ...
    integer i, l1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_ATOR: requested precision level exceeds default precision.'/ &
...
!   In version #2, the argument iprec is required.
    ...
    integer i, n1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_berne: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_DCTOZ: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_DCTOZ2: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer i1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_DTOR: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer i1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_DTOR2: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
  ...
  function mp_incgamma (ra, rb)
    ...
    call mpincgamma (ra%mpr, rb%mpr, mp_incgamma%mpr, mpnw)
    return
  end function
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_INIT: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_LOG2: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_PI: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #1, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_QTOR: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_RTOR: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_RTOZ: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READR1: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READR2: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READR3: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READR4: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READR5: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READZ1: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, l2, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READZ2: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, l2, l3, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READZ3: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, l2, l3, l4, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READZ4: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, l2, l3, l4, l5, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_READZ5: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
!   In version #2, the argument iprec is required.
    ...
    integer mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_STRCON: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
...
1     format ('*** MP_TAN: Cos of argument is zero.')
  ...
  function mp_zeta (ra)
    ...
    call mpzeta (ra%mpr, mp_zeta%mpr, mpnw)
    return
  end function
  ...
  function mp_zetaem (nb, rb, rc)
    ...
    n1 = mpwds
    call mpzetaem (n1, nb, rb(1)%mpr, rc%mpr, mp_zetaem%mpr, mpnw)
    return
  end function
...
!   In version #2, the argument iprec is required.
    ...
    integer l1, l2, mpnw
      if (iprec > mpwds) then
        write (mpldb, 1)
1       format ('*** MP_ZTOZ: requested precision level exceeds default precision.'/ &
          'Increase default precision in module MPMODF.')
        call mpabrt (98)
      endif
      mpnw = iprec
